...
//                                                   const ToolChain *toolChain,//#720 ROOPAK
    ...
    m_showErrors(true)
{
    if (!version || !version->isValid()/* || !toolChain*/) {//#720 ROOPAK
        m_invalidQt = true;
        return;
    }
...
//    toolChain->addToEnvironment(m_environment);//#720 ROOPAK - START
...
////    }//#720 ROOPAK - END
//    m_makeCommand = toolChain->makeCommand(m_environment);//#720 ROOPAK - END
