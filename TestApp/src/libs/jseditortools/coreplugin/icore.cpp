...
QString ICore::versionString()
{
    ...
    ideVersionDescription = tr(" (%1)").arg(QLatin1String(/*Constants::IDE_VERSION_DESCRIPTION_STR*/ "3.1.2"));
#endif
    return tr("Qt Creator %1%2").arg(QLatin1String(/*Constants::IDE_VERSION_LONG*/ "3.1.2"),
