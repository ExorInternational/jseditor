...
#ifndef QMLJSINDENTER_RENAMED_H//720 - ROOPAK - Renamed to avoid conflict with a file in qmljstools with the same file name.
#define QMLJSINDENTER_RENAMED_H//720 - ROOPAK - Renamed to avoid conflict with a file in qmljstools with the same file name.
